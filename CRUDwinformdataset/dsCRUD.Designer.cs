...
namespace CRUDwinformdataset.dsCRUDTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Users] SET [name] = @name, [age] = @age WHERE (([id] = @Original_id) AND " +
                "([name] = @Original_name) AND ([age] = @Original_age));\r\nSELECT id, name, age FR" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUDwinformdataset.Properties.Settings.Default.crudConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, age FROM Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "insert into Users(name, age)\r\nvalues (@name, @age)";
            ...
            this._commandCollection[2].CommandText = "UPDATE users set name=@name,age=@age where id=@id";
            ...
            this._commandCollection[3].CommandText = "SELECT id, name, age FROM Users\r\nwhere id=@id";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM users where id= @id";
        ...
        public virtual int Fill(dsCRUD.UsersDataTable dataTable) {
        ...
        public virtual dsCRUD.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCRUD.UsersDataTable dataTable = new dsCRUD.UsersDataTable();
        ...
        public virtual int FillBy(dsCRUD.UsersDataTable dataTable, int id) {
        ...
        public virtual dsCRUD.UsersDataTable GetDataByID(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            dsCRUD.UsersDataTable dataTable = new dsCRUD.UsersDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCRUD.UsersDataTable dataTable) {
